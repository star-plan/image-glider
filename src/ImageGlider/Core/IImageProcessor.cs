...
/// 图像颜色调整器接口
/// </summary>
public interface IImageColorAdjuster : IImageProcessor
{
    /// <summary>
    /// 调整单个图片文件的颜色
    /// </summary>
    ...
    /// <param name="quality">JPEG 质量</param>
    /// <returns>调整是否成功</returns>
    bool AdjustColor(string sourceFilePath, string targetFilePath, float brightness = 0, float contrast = 0, float saturation = 0, float hue = 0, float gamma = 1.0f, int quality = 90);
